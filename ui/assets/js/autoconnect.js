...
const howToUseEvidenceDAO = "https://www.youtube.com/playlist?list=PLdG1qxRmiG9N_RcS8E0Rmx5n4v0RnEOLL"
...
function setHowToPlayList() { 
	...
	connectVideoLinkSpan.append(createVideoLink(howToUseEvidenceDAO, "How to Use Evidence DAO", f));
	var c = getColoredNode("green");	
	connectVideoIconSpan.append(createVideoIcon(howToUseEvidenceDAO, c));
